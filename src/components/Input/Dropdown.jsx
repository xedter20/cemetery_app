...
const MyTextInput = ({
  ...
  let controlClassName = [
    'px-3 py-2 max-w-full border-gray-700 rounded w-full dark:placeholder-gray-400 border-red-600 ',
  ...
  return (
    <>
      <div className="mb-6 last:mb-0 mt-2">
        ...
        <div className={`relative ${meta.touched && meta.error ? 'rounded border-2 border-red-500' : ''}`}>
          <CreatableSelect
            placeholder="Select"
